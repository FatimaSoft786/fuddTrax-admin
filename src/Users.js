...
const Users = () => {
  ...
  const [activeNavIndex, setActiveNavIndex] = useState(4);
  ...
  useEffect(() => {
    ...
    axios
      .get("https://fuddtrax-backend-production.up.railway.app/api/user/fetch")
      .then((response) => {
            ...
            {users.map((e) => (
              ...
              >
                <div className=" flex flex-col justify-center items-center">
                  ...
                  <p className="text-black font-medium text-sm text-start w-[90%] my-2">
                   <b>UserId:</b>{e._id}
                  </p>
                  <p className="text-black font-medium text-sm text-start w-[90%] mb-2">
                 <b>Username:</b>{e.name}
                  </p>
                  <p className="text-black font-medium text-sm text-start w-[90%] h-auto mb-2">
                  <b>Registered time:</b>{moment(e.createAt).format("DD-MM-YYYY")}
                  </p>
                  <div
